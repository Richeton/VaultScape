...
public:
	...
	// Set Animation
	virtual void setAnimation(int startFrame, int endFrame, float frameDelay, float scale, float degrees, bool loop, bool visible)
	{
	...
	// Set Animation
	virtual void setAnimation(int currentFrame, int startFrame, int endFrame, float frameDelay, float scale, float degrees, bool loop, bool visible)
	{
	...
	virtual void printText(TextDX text, std::string msg);
